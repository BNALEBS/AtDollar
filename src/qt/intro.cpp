...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Atdollar Core"),
     ...
     * override -datadir in the atdollar.conf file in the default data directory
     * (to be consistent with atdollard behavior)
     */
    if(dataDir != getDefaultDataDirectory())
