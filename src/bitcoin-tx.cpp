...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Atdollar Core atdollar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  atdollar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded atdollar transaction") + "\n" +
              "  atdollar-tx [options] -create [commands]   " + _("Create hex-encoded atdollar transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded atdollar transaction
