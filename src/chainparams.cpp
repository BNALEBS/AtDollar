...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2.8 * 24 * 60 * 60; // two weeks
        nTargetSpacing = 2 * 60;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("1b6381fb357d64ef72173ec07ca65b8f89e03126ce79ddab7195ffc1a25a86966c6de9dd30e684e3c374e22bf0651707dcd45535c71b625b9f4c4b73ff682a00a7") << OP_CHECKSIG;
		...
		vFixedSeeds.clear();
		//vSeeds.push_back(CDNSSeedData("owpos.com", "seeds.owpos.com"));
