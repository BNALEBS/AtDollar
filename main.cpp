...
int64 nChainStartTime = 1423119000;
...
{
	int64 nSubsidy = 2.1 * COIN;

	if(nHeight == 1)
	{
		nSubsidy = 900000000 * COIN;	
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "AtdCoin creat!!-2015.2.5";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("03079c45a40f8c0113dc9c0664d77f04d606e03d7927425b7103ff30b2f2ce71"));
...
unsigned char pchMessageStart[4] = { 0xf5, 0xf4, 0xf9, 0x1c };
